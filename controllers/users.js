...
userRouter.post('/', async (request, response) => {
  ...
  // Comprobar que el email no se encuentre en uso
  ...
  // Si los campos no están completos o no son correctos
  ...
  await transporter.sendMail({
    ...
    subject: 'Verifique su email', // Asunto
    text: 'Hola, gracias por registrarse en Mariol Design', // Cuerpo del mensaje
    html: `
    <html>
  <head>
